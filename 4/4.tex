...
\caption{Absorptionsspektrum \\ \label{fig:absA} von Probe A}
\end{subfigure}
\begin{subfigure}[h]{0.4\textwidth}
...
\begin{figure}[H]
\caption{Spektra \label{fig:gluehlampen} an der Glühlampe}
...
\caption{Detail aus dem Transmissionsspektrum \label{fig:interfdetail} des Interferenzfilters}
\end{subfigure}
\begin{subfigure}[h]{0.4\textwidth}
...
\begin{flushleft}
\fbox{FWHM bei(8.3 $\pm$ 0.4)nm um eine zentrale Wellenlänge (CWL) von(480 $\pm$ 1) nm} \\
\end{flushleft}
